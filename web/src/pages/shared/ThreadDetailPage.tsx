...
export function ThreadDetailPage() {
  ...
  const handleModerate = async (action: string) => {
    await supabase.functions.invoke('forum/moderate-thread', {
  ...
  const handleAcceptAnswer = async (replyId: string) => {
    await supabase.functions.invoke('forum/moderate-reply', {
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                {author?.id && courseId && <InstructorBadge courseId={courseId} userId={author.id} />}
